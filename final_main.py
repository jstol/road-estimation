...
_argument_parser.add_argument('--test-data',
	dest='test_data_file',
	help='the test data file to use',
	required=True
)
_argument_parser.add_argument('--test-predictions-output',
	dest='test_predictions_file',
	help='the file to write the test predictions to',
	required=True
)
...
if __name__ == '__main__':
	...
	test_output_file = args.test_predictions_file
	...
	create_dir_if_not_exists(test_output_file)
	...
	with open(output_file, 'w') as f:
		...
		writer.writerow({
			...
			'predict_time': predict_test_time,
			'ce': test_ce,
			'classification_rate': test_class_rate,
	...
	# Save predictions
	np.savez(test_output_file, predictions=test_pred)
