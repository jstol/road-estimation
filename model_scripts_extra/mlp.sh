...
params_set=( \
	...
	'{"list_of_layers_params": [{"role":"hidden", "type":"Tanh", "units": 50, "weight_decay": 0.0000001}, {"role":"hidden", "type":"Tanh", "units": 25, "weight_decay": 0.0000001}, {"role":"hidden", "type":"Tanh", "units": 5, "weight_decay": 0.0000001}, {"role":"output", "type":"Softmax"}]}' \
	'{"list_of_layers_params": [{"role":"hidden", "type":"Tanh", "units": 100, "weight_decay": 0.0000001}, {"role":"hidden", "type":"Tanh", "units": 25, "weight_decay": 0.0000001}, {"role":"hidden", "type":"Tanh", "units": 5, "weight_decay": 0.0000001}, {"role":"output", "type":"Softmax"}]}' \
