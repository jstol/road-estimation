...
iteration_list = [('blur', 1), (1.5, 5), (1.0, 5), (0.5, 5)] # not too sure how you want to do this - first number is temp and second is number of MRF updates
...
for filename in os.listdir(original_prediction_dir):
    if fnmatch.fnmatch(filename, '*.png'):
        ...
        predicted_labels.set_conn_energy(1.0) #this is required to set the strength of connections ()
